...
. Create ArgoCD link:https://raw.githubusercontent.com/redhatryan/gitops/main/gitops-cluster/cluster-onboarding-app.yaml[application] to keep kubernetes resources synced that are required for the Cluster generator 
...
----
oc create -f https://raw.githubusercontent.com/redhatryan/gitops/main/gitops-cluster/day2-app.yaml
----
